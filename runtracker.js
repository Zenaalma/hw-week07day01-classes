class RunTracker {
    ...
    addrun(userDate , userTime ,userDistant){
        // "9/10/2012", 4, 10
        let userRun = 
        {
            date: userDate,
        ...
        this.run.push( {date:date,
            ...
            //  averageSpeed(){
            //     let average = this.run.reduce((prev,curr) => this.run.prev.distance + curr.distance / this.run.reduce ((prev,curr) => prev.time+ curr.time) )
            //     console.log (average)
            //     return average
            // }
            averageSpeed(){
        ...
        // const myRunTracker = new RunTracker(“Sara”,“Sara@cc.com”)
        // console.log(myRunTracker,run)
        const runner = new RunTracker(“zena”, “zena.com”);
